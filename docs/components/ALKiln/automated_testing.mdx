...
:::tip
([Moving](writing_tests.mdx#secrets))
...
([Moving](setup.mdx#sandbox-how-to))
...
([Moving](troubleshooting.mdx#docker-container))
...
([Moving](writing_tests.mdx#refresh))
...
([Moving](writing_tests.mdx#story-table))
...
([Moving](writing_tests.mdx#alkiln_story))
...
(Moving to [Story Table](writing_tests.mdx#story-table) and to [setting values](writing_tests.mdx#values))
...
([Moving](writing_tests.mdx#values))

_Simple field types with their values._

([Moving](writing_tests.mdx#yesno))
...
([Moving](writing_tests.mdx#yesnomaybe))
...
([Moving](writing_tests.mdx#checkboxes))
...
([Moving](writing_tests.mdx#radio))
...
([Moving](writing_tests.mdx#there-is-another))
...
([Moving](writing_tests.mdx#unused_rows))
...
([Moving](writing_tests.mdx#steps))
...
([Moving](writing_tests.mdx#gherkin-keywords))
...
([Moving](writing_tests.mdx#start))
...
([Moving](writing_tests.mdx#start-interview))
...
<!-- Added and Moved: Maybe put this in the errors/warnings section:
...
([Moving](writing_tests.mdx#observe))
...
([Moving](writing_tests.mdx#invalid))
...
([Moving](writing_tests.mdx#phrase))
...
([Moving](writing_tests.mdx#a11y))

The `accessibility` Step can <Anchor id="accessibility">check a page for its accessibility</Anchor> by running [aXe-core](https://github.com/dequelabs/axe-core) on the page.
...
([Moving](writing_tests.mdx#compare-json))
...
([Moving](writing_tests.mdx#get-json))
...
([Moving](writing_tests.mdx#choice-values-tip))
...
([Moving](writing_tests.mdx#today))
...
([Moving](writing_tests.mdx#tap-nav))
...
([Moving](writing_tests.mdx#address))
...
([Moving](writing_tests.mdx#download))
...
([Moving](writing_tests.mdx#compare-files))
...
([Moving concept](writing_tests.mdx#upload). Step deprecated in favor of regular variable setting)
...
([Moving](writing_tests.mdx#id-tip))
...
([Moving](writing_tests.mdx#noyes))
...
([Moving](writing_tests.mdx#html-tip))
...
([Moving](writing_tests.mdx#unstable-tip))
...
([Moving](writing_tests.mdx#reuse-tip))
...
([Moving](writing_tests.mdx#artifacts))
...
([Moving](writing_tests.mdx#error-pics))
...
([Moving](writing_tests.mdx#report))
...
([Moving](troubleshooting.mdx#next-page-timeout))
...
([Moving](troubleshooting.mdx#invalid-path))
...
([Moving](troubleshooting.mdx#table-cells))
...
([Moving](security.mdx#testing-server))
...
([Moving](security.mdx#github-workflow))
...
This section requires prior technical knowledge about [npm](https://docs.npmjs.com/about-npm) and [GitHub workflow files](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions). Feel free to [ask us](/docs/get_started/intro.md#join-the-community) any questions you might have.
...
([Moving](security.mdx#github-redacts-secrets))
...
These following sections probably require prior technical knowledge about [GitHub workflow files](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions). Feel free to [ask us](/docs/get_started/intro.md#join-the-community) any questions you might have.

### Required inputs

([Moving](writing_tests.mdx#githubNyou-inputs))
...
([Moving](writing_tests.mdx#optional-inputs) - some optional inputs)
([Moving](writing_tests.mdx#githubNyou-optional-inputs) - other optional inputs)
...
Deleted in favor of the [SERVER_RELOAD_TIMEOUT_SECONDS input](writing_tests.mdx#githubNyou-optional-inputs).
...
([Moving](writing_tests.mdx#env-vars))
...
([Moving](writing_tests.mdx#issue))
...
([Moving](writing_tests.mdx#trigger-tests))
...
([Moving](writing_tests.mdx#schedule-trigger))
...
([Moving](writing_tests.mdx#pr-trigger))
...
([Moving](writing_tests.mdx#new-file))
...
([Moving](writing_tests.mdx#file-rules))
...
([Moving](writing_tests.mdx#scenario-descriptions))
